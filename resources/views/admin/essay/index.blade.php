...
@section('content')
                      ...
                      <tr>
                        @foreach ($datas as $key=>$row)
                          ...
                          <td class="border text-center">
                              <a href="{{ route("admin.essay.edit",$row->id) }}" class="btn btn-xs btn-sm active btn-success" role="button">编辑</a>
      ...
      <script type="text/javascript">
          ...
          function del(id) {
              ...
              if(res){
                  location.href = "/admin/essay/delete/" +id;
              }
          }
